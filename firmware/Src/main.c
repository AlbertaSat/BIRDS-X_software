...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, GPIO_PIN_11|RFET_EN_OUT_PIN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : PA11 RFET_EN_OUT_PIN_Pin */
  GPIO_InitStruct.Pin = GPIO_PIN_11|RFET_EN_OUT_PIN_Pin;
